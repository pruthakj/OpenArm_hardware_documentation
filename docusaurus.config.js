...
const config = {
  ...
  url: 'https://pruthakj.github.io',
  // Set the /<baseUrl>/ pathname under which your site is served
  // For GitHub pages deployment, it is often '/<projectName>/'
  baseUrl: '/OpenArm_hardware_documentation/',
    ...
    ({
      ...
      navbar: {
        ...
        items: [
          ...
          {
            href: 'https://github.com/pruthakj/OpenArm_hardware_documentation',
            label: 'GitHub',
            position: 'right',
          },
        ],
      ...
      footer: {
        ...
        copyright: `Copyright © ${new Date().getFullYear()} OpenArm Project. Built with Docusaurus.`,
      },
      prism: {
