...
const components = [
  { name: '250x190mm Base Plate', image: 'base_plate.png', model: 'MVBLK-ASN-47P-4ELKT-L', qty: 1, unitPrice: '¥9,559', totalPrice: '¥9,559', method: 'Metal Cutting (CNC)', material: 'Al6061', manufacturer: 'MiSUMi MEVIY'},
];
