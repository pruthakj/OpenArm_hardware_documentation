...
<img src={useBaseUrl('/img/end-effector/spec.png')} alt="step4" style={{ display: 'block', margin: '0 auto', width: '90%', maxWidth:'600px' }} />
...
<figure style={{ textAlign: 'center' }}>
  <img
    src={useBaseUrl('/img/end-effector/fullyopen.png')}
    alt="step4"
...
<figure style={{ textAlign: 'center' }}>
  <img
    src={useBaseUrl('/img/end-effector/fullyclosed.png')}
    alt="step4"
    style={{ display: 'block', margin: '0 auto', width: '90%', maxWidth: '600px' }}
  />
  <figcaption style={{ fontSize: '0.9em', color: '#666', marginTop: '0.5em' }}>
