...
OpenArm 1 design is flexible and allows you to easily attach your own custom end-effector (e.g., grippers, cameras, tools) with minimal changes to the existing structure.
